          ...
          <div class="col-12 col-md-6">
            ...
            <div>
              ...
              >
                ...
                ></b-carousel-slide>
                <b-carousel-slide
                  caption="Location Choose"
                  img-src="choose_location.png"
                ></b-carousel-slide>
                <b-carousel-slide
      ...
      <div class="container">
        <div class="row align-items-lg-center">
          <div class="col-12 col-md-8">
            ...
            <p>
              Kami adalah mahasiswa/i Teknik Komputer Universitas Indonesia 2018
              yang bertekad membuat perubahan di UI! 
            </p>
            <a class="btn mt-4 mb-5 mb-md-0 contact-button" href="/contact-us"
...
#title {
  background: linear-gradient(rgba(255, 255, 255, 0.15), rgba(255, 255, 255, 0.15)), url("https://images.unsplash.com/photo-1506521781263-d8422e82f27a?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1350&q=80");
  /* background: linear-gradient(rgba(255, 255, 255, 1), rgba(16, 29, 44, 0.95)),
...
.redirect-button {
  ...
  transition: background-color color 650ms;
  /* border-color: #203980; */
  font-family: "Nunito";
}
